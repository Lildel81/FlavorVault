...
async function getResult() {
    let q = document.getElementById("recipeSearch").value; 
    ...
    try {
        ...
        document.getElementById("image").src = imageUrl; //displays the image to 'recipeImage' in the HTML.
        ...
        document.getElementById("name").innerText = recipeName; //replace "recipeName" with whatever element will display the name
